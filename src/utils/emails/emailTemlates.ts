function _HTML_TEMPLATE_WELLCOME_CREDENTIALS(config: any) {
    return `<!DOCTYPE html>
   <html>
  <head>
    <meta charset="utf-8" />
            ...
            <tr>
              ...
              >
                <p style="margin: 0">
                  ...
                  <br />
                  We are Delighted to well come you to Cultural Intelligence
            ...
            <tr>
              ...
              >
                <p style="margin: 0">
                  ...
                  Culture Intelligence for your account. If you didn't request
...
function _HTML_TEMPLATE_SEND_CAMPAIGN_DETAILS(config: any) {
    return `<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
        <meta http-equiv="x-ua-compatible" content="ie=edge" />
        <title>New Campaign is booked</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <style type="text/css">
            /**
   * Google webfonts. Recommended to include the .woff version for cross-client compatibility.
                        ...
                        <tr>
                            ...
                            >
                                <p style="margin: 0">
                                    <!-- <b>Hi,</b> <br /> -->
                                    <br />
                                    New Campaign is booked
                                </p>
                                <br /><br />
                                <b>Name : ${config.name} </b><br />
                                <b>Email : ${config.email} </b><br />
                                <b>User Name: ${config.username} </b><br />
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td align="center" bgcolor="#ffffff" style="padding: 12px">
                                            <table border="0" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    <td align="center" bgcolor="#7211A2" style="border-radius: 6px">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px">
                        ...
                        <tr>
                            <td
                                ...
                                "
                            >
                                <p style="margin: 0"><b>Tobacco Dock</b> Wapping Lane, London, E1W 2SF</p>
                            </td>
                        </tr>
                        <!-- end unsubscribe -->
                    </table>
...
function _HTML_TEMPLATE_CONTACT_US() {
    return `<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
                        ...
                        <tr>
                            ...
                            >
                                <p style="margin: 0">
                                    <!-- <b>Hi,</b> <br /> -->
                                    <br />
                                    Thank you for reaching. We will get back to you shortly.
                                </p>
                                <br /><br />
                            </td>
                        </tr>
...
function _HTML_TEMPLATE_DEMO_CULTURALY(config) {
    return `<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
                        ...
                        <tr>
                            ...
                            >
                                <p style="margin-left: 60px;" >
                                    ...
                                    <b>Name : ${config.name} </b><br /> <br>
                                    <b>Email : ${config.email} </b><br /> <br>
                                    <b>Category : ${config.category} </b><br /><br>
                                    <b>Message : ${config.message} </b><br /><br>
                                </p>
                                <br /><br />
                            </td>
                        </tr>
...
function _HTML_TEMPLATE_SEND_INVOICE(config: any) {
    return `<!DOCTYPE html>
<html>
    <head>
        <meta charset="utf-8" />
                        ...
                        <tr>
                            ...
                            >
                                <p style="margin-left: 70px">
                                    <!-- <b>Hi,</b> <br /> -->
                                    <br />
                                    New invoice is generated by Media owner.
                                
                                <br /><br />
                                <b>Name : ${config.name} </b><br /> <br />
                                <b>Email : ${config.email} </b><br /> <br />
                                <b>User Name: ${config.username} </b><br /> <br />
                                <b>Adbutler ID: ${config.publisherId} </b><br /> <br />
...
function _HTML_TEMPLATE_SEND_FORGOT_PASSWORD(config: any) {
    return `<!DOCTYPE html>
<html>
...
<head>
  <meta charset="utf-8" />
  <meta http-equiv="x-ua-compatible" content="ie=edge" />
  <title>Reset your Cultural Intelligence Password</title>
  <meta name="viewport" content="width=device-width, initial-scale=1" />
  <style type="text/css">
    /**
   * Google webfonts. Recommended to include the .woff version for cross-client compatibility.
